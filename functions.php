...
if ( ! function_exists( 'restaurateur_theme_customizer' ) ) :
	function restaurateur_theme_customizer( $wp_customize ) {
		...
		$wp_customize->add_setting( 'restaurateur_logo' );
		...
		$wp_customize->add_setting( 'restaurateur_facebook' );
		...
		$wp_customize->add_setting( 'restaurateur_twitter' );
		...
		$wp_customize->add_setting( 'restaurateur_google' );
		...
		$wp_customize->add_setting( 'restaurateur_pinterest' );
		...
		$wp_customize->add_setting( 'restaurateur_linkedin' );
		...
		$wp_customize->add_setting( 'restaurateur_youtube' );
		...
		$wp_customize->add_setting( 'restaurateur_tumblr' );
		...
		$wp_customize->add_setting( 'restaurateur_instagram' );
		...
		$wp_customize->add_setting( 'restaurateur_flickr' );
		...
		$wp_customize->add_setting( 'restaurateur_vimeo' );
		...
		$wp_customize->add_setting( 'restaurateur_yelp' );
		...
		$wp_customize->add_setting( 'restaurateur_opentable' );
		...
		$wp_customize->add_setting( 'restaurateur_rss' );
		...
		$wp_customize->add_setting( 'restaurateur_slider_timeout' );
...
function restaurateur_posted_on() {
	printf( __( ' <span class="sep meta-by"> 作者： </span> by <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span> <span class="byline"><span class="sep meta-on">文章发表于: </span></span>', 'restaurateur' ),
